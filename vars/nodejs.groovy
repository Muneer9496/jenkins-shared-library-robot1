...
def call() {
    node {
        git branch: 'main', url: "https://github.com/Muneer9496/${COMPONENT}.git"
        env.APP_TYPE = "nodejs" 
        common.lintChecks()
...
//             steps {
//                 script {
//                         env.UPLOAD_STATUS=sh(returnStdout: true, script: 'curl -L -s http://172.31.5.97:8081/service/rest/repository/browse/${COMPONENT} | grep ${COMPONENT}-${TAG_NAME}.zip || true')
//                         print UPLOAD_STATUS
//                     }
//                 }
//             }
